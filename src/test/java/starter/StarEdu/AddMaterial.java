...
public class AddMaterial extends PageObject {
    ...
    private By materialSection() { return By.id("content-undefined");}
    ...
    @Step
    public void fillDescriptionForMaterial(String DescriptionVideo) { $(fillDescriptionMaterial()).type(DescriptionVideo);}
    @Step
    ...
    @Step
    public void fillSeacrhMaterialField(String SearhFolder) { $(fillDescriptionMaterial()).type(SearhFolder);}
